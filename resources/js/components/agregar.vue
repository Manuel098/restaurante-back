<template>
  <div class="text-center">
    <v-dialog v-model="dialog" width="400" persistent>
      <v-card>
        <v-card-title class="center light-green accent-2" primary-title>{{titulo}}</v-card-title>
        ...
        <v-card-actions center>
          ...
          <v-btn class="text-left" color="red" text @click="cancelar()">Cancelar</v-btn>
          <spacer />
          <v-btn color="green" text @click="aceptar()">Aceptar</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </div>
